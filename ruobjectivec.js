...
let engWords = 
[
    'void','char','short','int','long','float','double','signed','unsigned','id','const','volatile','in','out','inout','bycopy','byref','oneway','self','super','@interface','@end','@implementation','@class','@protocol','@private','@protected','@public','@try','@throw','@catch','@finally','@selector','@encode','@synchronized'
]
let ruWords = 
[
    'пустой','символ','короткий','целочисленный','длинный','плавающий','двойной','знаковый','беззнаковый','идентификатор','константа','изменчивый','в','вне','вход','копирование','ссылочный','односторонний','само','супер','@интерфейс','@конец','@реализация','@класс','@протокол','@личный','@защищённый','@открытый','@попробовать','@выброс','@ловить','@окончательно','@переключатель','@кодировать','@синхронизированный'
]
function initLoad()
{
	if (!pageLoaded)
