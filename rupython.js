...
let ruWords = 
[
    'Ложь','Ничего','Истина','и','как','утверждать','асинхронный','ожидать','выход','класс','продолжить','метод','удалить','иначеесли','иначе','кроме','окончательно','для','из','глобальный','если','импорт','в','является','лямбда','нелокальный','не','или','пропустить','поднимать','вернуть','попробовать','пока','с','отдать'
]
function initLoad()
{
	if (!pageLoaded)
