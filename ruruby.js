...
let engWords = 
[
    'alias','and','BEGIN','begin','break','case','class','def','defined?','do','else','elsif','END','end','ensure','false','for','if','in','module','next','nil','not','or','redo','rescue','retry','return','self','super','then','true','undef','unless','until','when','while','yield','__ENCODING__','__LINE__','__FILE__'
]
let ruWords = 
[
    'псевдоним','и','НАЧАЛО','начало','выход','случай','класс','метод','опредено?','делать','иначе','иначеЕсли','КОНЕЦ','конец','гарантия','ложь','для','если','в','модуль','следующий','нуль','не','или','переделать','спасение','перепробовать','вернуть','само','супер','то','истина','неопределенный','кроме','до','когда','пока','отдать','__КОДИРОВКА__','__ЛИНИЯ__','__ФАЙЛ__'
]
function initLoad()
{
	if (!pageLoaded)
