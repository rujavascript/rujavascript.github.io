...
let ruWords = 
[
    'как','случай','из','класс','данные','семья','пример','стандартный','вывод','делать','длявсех','чужой','скрытие','если','тогда','иначе','импорт','приставка','приставкаслева','приставкасправа','пусть','в','рекурсивноделать','модуль','новыйтип','процесс','квалифицированный','рекурсия','тип','где'
]
function initLoad()
{
	if (!pageLoaded)
