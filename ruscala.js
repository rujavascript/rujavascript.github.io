...
let ruWords = 
[
    'абстрактный','случай','ловить','класс','метод','делать','иначе','расширяет','ложь','окончательный','окончательно','для','дляНекоторых','если','скрытый','импорт','ленивый','выбор','новый','нуль','объект','переопределенный','пакет','личный','защищённый','вернуть','запечатанный','супер','этот','выброс','особенность','истина','попробовать','тип','константа','переменная','пока','с','отдать'
]
function initLoad()
{
	if (!pageLoaded)
