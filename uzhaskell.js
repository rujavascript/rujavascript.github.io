...
let engWords = 
[
    'as','case','of','class','data','family','instance','default','deriving','do','forall','foreign','hiding','if','then','else','import','infix','infixl','infixr','let','in','mdo','module','newtype','proc','qualified','rec','type','where'
]
let ruWords = 
[
    "qanaqasiga","sodirbo'lmoqda","dan","sinf","ma'lumotlar","oila","misol","standart","xulosa","qil","barchauchun","begona","yashirish","agar","keyin","aksholda","import","konsol","chapdagibiriktirma","o'ngdagibiriktirma","ruxsatbering","v","rekursivbajaring","modul","yangitur","jarayon","malakali","rekursiya","turi","qayerda"
]
function initLoad()
{
	if (!pageLoaded)
