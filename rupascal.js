...
let engWords = 
[
    'and','array','begin','case','const','div','goto','do','downto','else','end','file','for','function','if','label','mod','not','or','of','object','procedure','program','record','repeat','set','string','then','to','type','unit','until','uses','var','while','with','xor'
]
let ruWords = 
[
    'и','массив','начало','случай','константа','делениеНацело','переходК','делать','спускВниз','иначе','конец','файл','для','функция','если','метка','остаток','не','или','из','объект','процедура','программа','запись','повтор','набор','строка','то','к','тип','модуль','до','использовать','переменная','пока','с','исключающееИли'
]
function initLoad()
{
	if (!pageLoaded)
